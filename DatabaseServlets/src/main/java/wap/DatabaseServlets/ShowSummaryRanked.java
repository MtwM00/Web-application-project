...
/**
 * Servlet implementation class ShowSummaryRanked
 */
@WebServlet("/ShowSummaryRanked")
public class ShowSummaryRanked extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ps = conn.prepareStatement("SELECT u_nickname, u_name, u_surname, u_elo,score\r\n"
					+ "FROM user\r\n"
